...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitbiTestFramework
    pass


class ExampleTest(BitbiTestFramework):
    # Each functional test is a subclass of the BitbiTestFramework class.
    ...
    def custom_method(self):
        ...
        BitbiTestFramework class so other tests can use it."""
