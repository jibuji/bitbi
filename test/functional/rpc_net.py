#!/usr/bin/env python3
# Copyright (c) 2017-present The Bitbi Core developers
...
class NetTest(BitbiTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=9801)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 9801)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=9801), {"success": False})
