#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Bitbi Core developers
...
class TxDownloadTest(BitbiTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new bitbid instances, as setting mocktimes has long-term effects on when
