#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Bitbi Core developers
...
class I2PPorts(BitbiTestFramework):
    ...
    def run_test(self):
        ...
        addr = "zsxwyo6qcn3chqzwxnseusqgsnuw3maqnztkiypyfxtya4snkoka.b32.i2p:9801"
        raised = False
        try:
