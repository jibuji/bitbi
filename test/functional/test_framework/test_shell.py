...
class TestShell:
    """Wrapper Class for BitbiTestFramework.

    The TestShell class extends the BitbiTestFramework
    ...
    class __TestShell(BitbiTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitbiTestFramework child class.
            self.num_nodes = 1
