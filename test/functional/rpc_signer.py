...
Verify that a bitbid node can use an external signer command.
...
class RPCSignerTest(BitbiTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitbid with -signer=<cmd>',
