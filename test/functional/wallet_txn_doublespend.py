...
class TxnMallTest(BitbiTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BTB:
        ...
        # First: use raw transaction API to send 1240 BTB to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BTB coin each
        ...
        # Node0's balance should be starting balance, plus 50BTB for another
        ...
        # Node0's total balance should be starting balance, plus 100BTB for
