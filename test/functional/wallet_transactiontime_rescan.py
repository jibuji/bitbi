...
class TransactionTimeRescanTest(BitbiTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BTB and create transactions
        ...
        # generate some btb to create transactions and check blockcount
        ...
        # send 10 btb to user's first watch-only address
        self.log.info('Send 10 btb to user')
        ...
        # send 5 btb to our second watch-only address
        self.log.info('Send 5 btb to user')
        ...
        # send 1 btb to our third watch-only address
        self.log.info('Send 1 btb to user')
