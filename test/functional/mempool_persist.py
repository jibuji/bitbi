...
By default, bitbid will dump mempool on shutdown and
...
class MempoolPersistTest(BitbiTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitbid from writing mempool.dat to disk. Verify that `savemempool` fails")
