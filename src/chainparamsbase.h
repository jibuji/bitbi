// Copyright (c) 2014-2020 The Bitbi Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between bitbi-cli and bitbid)
 * of a given instance of the Bitbi system.
 */
