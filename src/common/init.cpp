// Copyright (c) 2023 The Bitbi Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // bitbi.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/bitbi/bitbi/issues/16220 about ways to
        ...
        // Show an error or warning if there is a bitbi.conf file in the
