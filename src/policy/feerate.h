...
const std::string CURRENCY_UNIT = "BTB"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BTB_KVB,      //!< Use BTB/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BTB_KVB) const;
