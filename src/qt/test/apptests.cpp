...
//! Entry point for BitbiApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitbiApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitbiGUI tests.
void AppTests::guiTests(BitbiGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitbiGUI::consoleShown, this, &AppTests::consoleTests);
