...
{
    // Test regression https://github.com/bitbi/bitbi/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bitbi-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitbi-core/gui/pull/568.
    // With fListen=false in ~/.config/Bitbi/Bitbi-Qt.conf and all else left as default,
    // bitbi-qt should set both -listen and -listenonion to false and start successfully.
