      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitbiAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitbiAtStartup);
    ...
    ui->bitbiAtStartup->setToolTip(ui->bitbiAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitbiAtStartup->setText(ui->bitbiAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitbiConfButton->setToolTip(ui->openBitbiConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitbiUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitbiAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBTBontrols);
...
void OptionsDialog::on_openBitbiConfButton_clicked()
{
