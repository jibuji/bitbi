...
/** Main Bitbi application object */
class BitbiApplication: public QApplication
{
    Q_OBJECT
public:
    explicit BitbiApplication();
    ~BitbiApplication();
    ...
    /// Get window identifier of QMainWindow (BitbiGUI)
...
Q_SIGNALS:
    ...
    void windowShown(BitbiGUI* window);
