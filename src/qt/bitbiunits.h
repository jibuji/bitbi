...
/** Bitbi unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitbiUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitbiUnits(QObject *parent);

    /** Bitbi units.
      @note Source: https://en.bitbi.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BTB,
        mBTB,
...
typedef BitbiUnits::Unit BitbiUnit;
