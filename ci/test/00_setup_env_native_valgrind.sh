#!/usr/bin/env bash
#
# Copyright (c) 2019-present The Bitbi Core developers
...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--exclude feature_init,rpc_bind,feature_bind_extra"  # Excluded for now, see https://github.com/bitbi/bitbi/issues/17765#issuecomment-602068547
export GOAL="install"
