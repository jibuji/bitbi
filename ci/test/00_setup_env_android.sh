...
export PACKAGES="unzip openjdk-17-jdk gradle"
...
export BITCOIN_CONFIG="--disable-tests --without-wallet --disable-gui-tests --disable-bench --disable-fuzz-binary --without-utils --without-libs --without-gui --with-daemon"
