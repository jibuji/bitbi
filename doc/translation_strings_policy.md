...
This document provides guidelines for internationalization of the Bitbi Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitbi_en.ts` remains unchanged.
