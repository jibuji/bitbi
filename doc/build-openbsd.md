...
This guide describes how to build bitbid, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/bitbi/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/bitbi/depends/x86_64-unknown-openbsd"
```

#### GUI Dependencies
###### Qt5

Bitbi Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/bitbi/bitbi/issues/6658)).
