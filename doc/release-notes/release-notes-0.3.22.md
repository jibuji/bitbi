Download URL: https://sourceforge.net/projects/bitbi/files/Bitbi/bitbi-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTB fee schedule (users still pay 0.01 BTB per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitbi00 - #bitbi99
