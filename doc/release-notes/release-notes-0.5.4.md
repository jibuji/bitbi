Bitbi version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitbi/files/Bitbi/bitbi-0.5.4/
...
http://gitorious.org/bitbi/bitbid-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitbi-Qt notifications under Growl 1.3.
Increase required age of Bitbi-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitbi properly when installing Bitbi-Qt over it. (Windows)
