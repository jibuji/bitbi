Bitbi Core version *0.15.2* is now available from:

  <https://bitbicore.org/bin/bitbi-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitbi-tx (TheBlueMatt)
