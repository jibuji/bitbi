Bitbi Core version 0.9.2.1 is now available from:

  https://bitbi.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTB to 0.01 BTB
...
- Fix "Start bitbi on system login"
