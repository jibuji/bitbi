Bitbi Core version 0.9.4 is now available from:

  https://bitbi.org/bin/0.9.4/
...
this update is incompatible with the Bitbi system and could lead to consensus
forks.

Bitbi Core released binaries from https://bitbi.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitbi/+archive/ubuntu/bitbi
- A third-party or self-compiled Bitbi Core

upgrade to Bitbi Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
