Bitbi Core version 0.13.2 is now available from:

  <https://bitbi.org/bin/bitbi-core-0.13.2/>
...
- #8908 `4a974b2` Update bitbi-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitbi-tx to create v2 transactions (btbdrak)
