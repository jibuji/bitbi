Bitbi Core version 0.16.1 is now available from:

  <https://bitbicore.org/bin/bitbi-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitbid with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitbid processes are cleaned up when tests end (sdaftuar)
