Bitbi Core version 0.10.4 is now available from:

  <https://bitbi.org/bin/bitbi-core-0.10.4/>
...
- #6953 `43c2789` Split bitbi-tx into its own package
- #6953 `dfe0d4d` Include bitbi-tx binary on Debian/Ubuntu
