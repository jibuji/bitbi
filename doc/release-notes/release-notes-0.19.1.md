...
Bitbi Core version 0.19.1 is now available from:

  <https://bitbicore.org/bin/bitbi-core-0.19.1/>
...
From Bitbi Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitbi Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitbi Core does not yet change appearance when
...
- #17488 fix "bitbid already running" warnings on macOS (fanquake)
