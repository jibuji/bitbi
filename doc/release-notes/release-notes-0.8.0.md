Bitbi-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitbi/files/Bitbi/bitbi-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitbi
...
New/changed settings (command-line or bitbi.conf file)
--------------------------------------------------------
