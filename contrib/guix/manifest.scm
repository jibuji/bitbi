...
(define* (make-bitbi-cross-toolchain target
                                       #:key
...
desirable for building Bitbi Core release binaries."
...
;; failure; see https://github.com/bitbi/bitbi/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-bitbi-cross-toolchain target)))
