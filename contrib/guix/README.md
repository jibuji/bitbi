# Bootstrappable Bitbi Core Builds

This directory contains the files necessary to perform bootstrappable Bitbi
Core builds.
...
To build Bitbi Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Bitbi Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/bitbi-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/bitbi-core/guix.sigs).
