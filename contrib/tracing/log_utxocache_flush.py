...
"""Example logging Bitbi Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitbid
...
def main(bitbid_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitbid_with_usdts])
