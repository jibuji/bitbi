...
complete --command bitbid --no-files

# Extract options
function __fish_bitbid_get_options
...
complete \
    --command bitbid \
    --arguments "(__fish_bitbid_get_options --nofiles)"
