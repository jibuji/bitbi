...
# Extract options
function __fish_bitbi_tx_get_options
...
# Extract commands
function __fish_bitbi_tx_get_commands
...
complete \
    --command bitbi-tx \
    --condition "not __fish_bitbi_seen_cmd (__fish_bitbi_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitbi_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitbi-tx \
    --arguments "(__fish_bitbi_tx_get_commands)" \
    --no-files
